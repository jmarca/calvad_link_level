...
var couchCache = function(opts){
    ...
    if(time_agg !== 'monthly' || time_agg !== 'weekly' || time_agg !== 'daily' || time_agg !== 'hourly') throw new Error('bad agg level '+opts.time_agg)

    var spatial_agg = opts.spatial_agg || 'freeway'
    if(spatial_agg !== 'freeway' || spatial_agg !== 'detector'){throw new Error('bad agg level '+opts.spatial_agg)}
