...
describe('couchCache get',function(){
    ...
    //                var c = r.body
    //                c.should.have.property('length',87)
    //                var did = {}
    //                _.each(c
    //                      ,function(record){
    //                           record.should.an.instanceOf(Array)
    //                           record[0].should.have.property('properties')
    //                           record[0].properties.should.have.property('detector_id')
    //                           var id = record[0].properties.detector_id
    //                           _.each(record,function(r){
    //                               r.should.have.property('type','Feature')
    //                               r.should.have.property('geometry')
    //                               r.should.have.property('properties')
    //                               r.properties.should.have.property('detector_id',id)
    //                           });

    //                           did.should.not.have.property(id)
    //                           did[id]=1
    //                       })
    //                return done()
    //            })
